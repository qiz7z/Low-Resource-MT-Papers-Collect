...
| 2025 | arXiv | [Advancing Retrieval-Augmented Generation For Persian: Development Of Language Models, Comprehensive Benchmarks, And Best Practices For Optimization](<papers/RAG-for-Low-Resource-MT/2025-arxiv-面向波斯语的检索增强生成技术进阶：语言模型开发、综合基准评测及优化最佳实践/2501.04858v1.pdf>) | RAG、波斯语、Sentence-BERT、RAGAS、文档摘要索引 | [中文笔记](<papers/RAG-for-Low-Resource-MT/2025-arxiv-面向波斯语的检索增强生成技术进阶：语言模型开发、综合基准评测及优化最佳实践/面向波斯语的检索增强生成技术进阶：语言模型开发、综合基准评测及优化最佳实践.md>) |
