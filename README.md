...
| 年份 | 会议 | 论文 | 关键词 | 笔记 |
|:---:|:---:|------|:------:|:----:|
| 2026 | 技术报告 | [HY‑MT1.5 技术报告](<papers/腾讯HY/腾讯HY1.5/腾讯-Hunyuan-MT-7B-支持藏语-开源模型权重.pdf>) | 多阶段训练流水线、SFT、策略蒸馏、GRPO 强化学习、术语干预、上下文感知翻译、格式保留、FP8/INT4 量化、藏语/少数民族语言 | [中文笔记](<papers/腾讯HY/腾讯HY1.5/HY-MT1.5-技术报告.md>) |
| 2026 | 技术报告 | [Hy‑MT2：面向真实场景的高速高效多语言翻译模型](<papers/腾讯HY/腾讯HY2.0/HYMT2-2605.22064v2.pdf>) | MoE 混合专家(30B‑A3B)、中间训练、以语言族为中心后训练(FCPT)、参考引导策略蒸馏、跨语言族蒸馏、GRPO、1.25bit 量化、指令遵循 | [中文笔记](<papers/腾讯HY/腾讯HY2.0/Hy-MT2-技术报告.md>) |
...
│   │   ├── 腾讯HY1.5/
│   │   │   ├── HY-MT1.5-技术报告.md
│   │   │   └── 腾讯-Hunyuan-MT-7B-支持藏语-开源模型权重.pdf
│   │   └── 腾讯HY2.0/
...
│   ├── Domain-Adaptation/             # 规划中：域自适应（待填充）
│   ├── LLM-for-MT/                    # 规划中：大语言模型翻译（待填充）
│   └── NMT-Basics/                    # 规划中：神经机器翻译基础（待填充）
├── .gitignore
...
| `维语/` | 维吾尔语方向专题研究 |
| `腾讯HY/` | 腾讯混元（Hunyuan）多语言翻译模型技术报告与模型权重 |
...
| `MoE 混合专家` | 藏语稠密与混合专家大语言模型 (2026)；Hy‑MT2 (2026) |
