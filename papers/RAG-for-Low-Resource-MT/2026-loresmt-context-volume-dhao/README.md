...
![图1：混合翻译流水线架构](images/pipeline-overview.png)
...
![表1：基线性能对比](images/baseline-performance.png)
...
![表7：NMT 失败案例与 LLM 修复效果](images/safety-net-effect.png)
...
![图2：上下文规模对性能的影响](images/context-volume-impact.png)
...
![图3：检索策略性能趋同](images/performance-convergence.png)
